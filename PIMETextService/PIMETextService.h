...
public:
    ...
    COLORREF candColor() const { return candColor_; }
    void setCandColor(COLORREF color) {
        candColor_ = color;
        if(candidateWindow_) candidateWindow_->setColors(candColor_, candBkColor_);
    }

    COLORREF candBkColor() const { return candBkColor_; }
    void setCandBkColor(COLORREF color) {
        candBkColor_ = color;
        if(candidateWindow_) candidateWindow_->setColors(candColor_, candBkColor_);
    }
